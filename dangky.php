...
if (isset($_POST['dangky'])) {
    ...
    $diachi = $_POST['diachi'];
    $sql_dangky = mysqli_query($mysqli, "INSERT INTO gb_dangky(tenkhachhang,email,diachi,matkhau,dienthoai) VALUES ('" . $tenkhachhang . "','" . $email . "','" . $diachi . "','" . $matkhau . "','" . $dienthoai . "')");
    if ($sql_dangky) {
...
<head>
    ...
    <title>Đăng ký</title>
    <link rel="stylesheet" href="./assets/style/dangky.css">
</head>
