...
if (isset($_POST['dangnhap'])) {
    ...
    $sql = "SELECT * FROM gb_dangky WHERE email='" . $email . "' AND matkhau='" . $matkhau . "' LIMIT 1 ";
...
<head>
    ...
    <link rel="stylesheet" href="./assets/style/dangnhap.css">
        ...
        <div class="container_contact">
            <div class="contact-box">
                <div class="left">
                    ...
                    <p>Bạn chưa có tải khoản ?<a href="dangky.php"> Đăng ký</a></p>
                </div>
                <div class="right">
                </div>
            </div>
